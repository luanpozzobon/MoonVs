...
public record TmdbSearch(int id, @JsonProperty("original_title") String originalTitle, String overview, @JsonProperty("media_type") ContentType contentType, @JsonProperty("vote_average") double voteAverage) { }
